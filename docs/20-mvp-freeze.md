...
- **Media Session API** — metadata & kontrol lock screen (`docs/27`) ✅ diimplementasi — dirilis `0.3.0`
- **Mode Murotal** — tilawah berkelanjutan (`docs/29`) ✅ diimplementasi — dirilis `0.3.0`
